    ...
    if (climberInfo) {
        ...
        profileHTML += `
            <div class="flex items-stretch space-x-4">
                ...
                ${climberGrade !== null ? `
                <div class="bg-gray-900 border border-gray-800 p-4 rounded-lg shadow-md text-center flex-shrink-0 flex flex-col justify-center" style="width: 120px; height: 100%;">
